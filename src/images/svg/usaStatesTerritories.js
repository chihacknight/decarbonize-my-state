export default {
  label: "Map of United States and Territories",
  viewBox: "0 0 928 587",
  locations: [
    {
      name: "Alaska",
    ...
    },
    {
      ...
      id: "delaware",
      path:
        "M834.4,247.2 l-1,0.5 -3.6,-2.4 -1.8,-4.7 -1.9,-3.6 -2.3,-1 -2.1,-3.6 0.5,-2 0.5,-2.3 0.1,-1.1 -0.6,0.1 -1.7,1 -2,1.7 -0.2,0.3 7.4,25.8 5,-0.3 6,-1.1z",
    },
    {
      name: "Florida",
      id: "florida",
